#!/usr/bin/env python3
"""
5-Stage Multi-Stage Gradient Optimization - DUAL DECAY VERSION
18 parameters (17 original + split decay into buy/sell), NO CONSTRAINTS
Testing hypothesis: Buy and Sell decay at different rates
"""
import ccxt
import pandas as pd
import numpy as np
...
def create_dashboard(df, signals, trades, params_dict, value, filename):
    ...
    ax1.set_title('5-Stage Optimized: All 17 Parameters (No Constraints)', fontsize=14, pad=10)
...
def main():
    print("\n" + "="*70)
    print("5-STAGE MULTI-STAGE GRADIENT OPTIMIZATION - DUAL DECAY")
    print("18 parameters (buy decay and sell decay separate), NO CONSTRAINTS")
    print("="*70 + "\n")
    ...
    params_dict = {
        ...
        'system': '5-stage optimization with DUAL DECAY (18 params, no constraints)'
    }

    with open('final_5stage_config.json', 'w') as f:
        json.dump(params_dict, f, indent=2)

    print("\n[INFO] Creating dashboard...")
    signals_df = pd.DataFrame(signals_list)
    create_dashboard(df_final, signals_df, trades, params_dict, final_value, 'final_5stage_dashboard.png')
    print("[OK] Saved to final_5stage_dashboard.png")
    print("[OK] Saved configuration to final_5stage_config.json")
